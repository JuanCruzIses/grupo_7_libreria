...
const validateRegister = [
    body("nombre").notEmpty().withMessage("Por favor complete con su nombre").isLength( {min: 5} ).withMessage("El Nombre debe tener al menos 5 caracteres").isLength( {max: 20} ).withMessage("El Nombre debe tener menos de 20 caracteres"),
    body("apellido").notEmpty().withMessage("Por favor complete con su apellido").isLength( {min: 5} ).withMessage("El Apellido debe tener al menos 5 digitos").isLength( {max: 20} ).withMessage("El Apellido debe tener menos de 20 caracteres"),
